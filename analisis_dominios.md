...
| Trazabilidad con HU | Las historias HU-06 a HU-12 se organizan alrededor de estos dominios, respetando la division oficial. |
...
|---|---------|-------------------|-------------|-----------|
| 1 | Configuration | `configuration` | `01_ddl/03_tables/configuration/` | Centraliza datos maestros: clientes, personas, empresa, empleados, metodos de pago, tipos de dia y precios. |
| 2 | Security | `security` | `01_ddl/03_tables/security/` | Gestiona usuarios, roles, permisos, modulos, vistas y relaciones de acceso. |
| 3 | Distribution | `distribution` | `01_ddl/03_tables/distribution/` | Organiza sedes, habitaciones, tipos, estados, catalogo y disponibilidad. |
| 4 | Service delivery | `service_delivery` | `01_ddl/03_tables/service_delivery/` | Controla reservas, cancelaciones, estadias, check in y check out. |
| 5 | Inventory | `inventory` | `01_ddl/03_tables/inventory/` | Administra proveedores, productos, servicios, ventas, seguimiento y disponibilidad de inventory. |
| 6 | Billing | `billing` | `01_ddl/03_tables/billing/` | Maneja pre factura, factura, pagos parciales y detalle de compra. |
| 7 | Notification | `notification` | `01_ddl/03_tables/notification/` | Agrupa promociones, alertas, terminos, condiciones y fidelizacion. |
| 8 | Maintenance | `maintenance` | `01_ddl/03_tables/maintenance/` | Registra maintenance de habitacion, uso, remodelacion y dashboard operativo. |
...
| HU | Dominios relacionados | Entregable | DoD |
|----|---|---|---|
| HU-06 | Configuration | 01_ddl/03_tables/configuration/ | DoD{Alcance{main}}] |
| HU-07 | Security | 01_ddl/03_tables/security/ | DoD{Alcance{main}}] |
| HU-08 | Distribution | 01_ddl/03_tables/distribution/ | DoD{Alcance{main}}] |
| HU-09 | Service delivery | 01_ddl/03_tables/service_delivery/ | DoD{Alcance{main}}] |
| HU-10 | Inventory | 01_ddl/03_tables/inventory/ | DoD{Alcance{main}}] |
| HU-11 | Billing | 01_ddl/03_tables/billing/ | DoD{Alcance{main}}] |
| HU-12 | Notification y Maintenance | 01_ddl/03_tables/notification/ + maintenance/ | DoD{Alcance{main}}] |
| HU-16 | Todos los dominios | 02_dml/01_inserts/ | DoD{Alcance{main}}] Seed{Canonicos} |
| HU-17 | Todos los dominios | 02_dml/01_updates/ + 03_upserts/ | DoD{Alcance{main}}] Seed{Volumetricos} |
